    ...
    <main>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                echo "<table><tr><th>Athlete</th><th>epreuve</th><th>Résultat</th><th>Modifier</th><th>Supprimer</th></tr>";
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><button onclick='openModifyResultForm(\"{$uniqueIdentifiantAction}\")'>Modifier</button></td><td><button onclick='deleteResultConfirmation(\"{$uniqueIdentifiantAction}\")'>Supprimer</button></td>";
                    echo "</tr>";
                }
