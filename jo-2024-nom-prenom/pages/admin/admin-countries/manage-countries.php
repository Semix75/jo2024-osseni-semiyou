        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td> <button onclick='openModifyCountrieForm({$row['id_pays']})'>Modifier</button></td> <td><button onclick='deleteCountrieConfirmation({$row['id_pays']})'>Supprimer</button></td>";
                    echo "</tr>";
                }
                echo "</table>";
            } else {
