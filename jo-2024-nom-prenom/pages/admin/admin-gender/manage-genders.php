...
<body>
        ...
        try {
            ...
            if ($statement->rowCount() > 0) {
                ...
                while ($row = $statement->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td> <button onclick='openModifyGenderForm({$row['id_genre']})'>Modifier</button></td> <td><button onclick='deleteGenderConfirmation({$row['id_genre']})'>Supprimer</button></td>";
                    echo "</tr>";
                }
    ...
    <script>
        ...
        function openModifyGenderForm(idGender) {
            // Ajoutez ici le code pour afficher un formulaire stylisé pour modifier un genre
            // alert(id_gender);
            window.location.href = 'modify-gender.php?idGender=' + idGender;
        }

        function deleteGenderConfirmation(idGender) {
            ...
            if (confirm("Êtes-vous sûr de vouloir supprimer ce genre?")) {
                ...
                // alert(id_gender);
                window.location.href = 'delete-gender.php?idGender=' + idGender;
            }
        }
    </script>
</body>
